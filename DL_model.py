...
class Are_U_Beatutifut:
    def __init__(self):
        ...
        self.read_dir = 'image/'
        self.save_dir = 'temp/'
        self.face_cascade = cv2.CascadeClassifier("haarcascades_cuda/haarcascade_frontalface_alt2.xml")
    ...
    def rating(self,image_path):
        ...
        result.append(flag)  #int 类型
        result.append(count) #int 类型
        result.extend(rating) #float 类型
        return result
